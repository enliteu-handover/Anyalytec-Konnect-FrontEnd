          ...
          {Object.keys(aDataValue).length > 0 &&
            <React.Fragment>
              <div className="n_award_add_col_inner_fromaward">
                <img src={aDataValue?.imageByte?.image || aDataValue.imageByte || `${process.env.PUBLIC_URL}/images/icons/static/No-Icon.svg`} className="r_award_img selected" alt="Award Icon" title={aDataValue?.award?.name} />
