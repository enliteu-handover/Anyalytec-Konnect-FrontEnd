...
console.log('children',children);
        return React.createElement('div', {
            ...
            className: children?.[0]?.props?.active ? 'org-tree-node-children org-tree-node-children-active' : 'org-tree-node-children'
        }, children);
    }
    return '';
};
