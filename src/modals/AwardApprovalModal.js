                      ...
                      <div className="p-3">
                        <div className="r_award_lcol_div">
                          <div className="r_award_lcol_inner text-left">
                            <img
                              src={(awardDatas?.imageByte || awardDatas?.award?.imageByte) ? (awardDatas?.imageByte?.image ||
                                awardDatas?.award?.imageByte?.image) : `${process.env.PUBLIC_URL}/images/icons/static/No-Icon.svg`}
